...
local dialogArr = {"Закурить сигарету (на улице)", "Выкинуть и потушить сигарету (на улице)", "Закурить сигарету в помещении (стоя) {ff0000}Не готово", "Выкинуть и потушить сигарету в помещении (стоя) {ff0000}Не готово", "Закурить сигарету в помещении (сидя) {ff0000}Не готово", "Выкинуть и потушить сигарету в помещении (сидя с пепельницей) {ff0000}Не готово"}
local dialogStr = ""
